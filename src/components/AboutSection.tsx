...
import hack_image from "../lib/hack_image.jpeg"
const AboutSection = () => {
  const education = [
    {
  ...
  const achievements = [
    {
      title: "Hack your path 6.0 - Hackathon",
      award: "Certificate of Appreciation",
      icon: FaTrophy,
      image: hack_image, // Add your image path here
      linkedin: "https://www.linkedin.com/posts/kalyankumarmudike_hackyourpath6-hackathonexperience-agritech-activity-7333498133777207296-Ppo9?utm_source=social_share_send&utm_medium=member_desktop_web&rcm=ACoAAE9CHN4BamFLJImXSmAIbZUWGWgx7_xpSe4" // Add your LinkedIn link here
    }
  ];
          ...
          <div className="gradient-border card-3d max-w-4xl mx-auto">
            <div className="gradient-border-content p-8">
              ...
              <p className="text-gray-300 text-lg leading-relaxed">
                I'm a passionate Computer Science Engineering student with a strong foundation in MERN stack development and data structures & algorithms. I love creating innovative web applications that solve real-world problems. Through various projects and certifications, I've developed expertise in full-stack development. I'm always eager to learn new technologies and contribute to meaningful projects that make a positive impact.
              </p>
            </div>
          </div>
        </motion.div>
