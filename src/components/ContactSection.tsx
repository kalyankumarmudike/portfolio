...
const ContactSection = () => {
  const contactInfo = [
    {
      name: "Email",
      value: "kalyanmudike@gmail.com",
      url: "mailto:kalyanmudike@gmail.com",
      icon: FaEnvelope,
      color: "#EA4335"
    },
    {
      name: "LinkedIn",
      value: "linkedin.com/in/kalyankumarmudike",
      url: "https://www.linkedin.com/in/kalyankumarmudike/",
      icon: FaLinkedin,
      color: "#0077B5"
    },
    {
      name: "GitHub",
      value: "github.com/kalyankumarmudike",
      url: "https://github.com/kalyankumarmudike",
      icon: FaGithub,
      color: "#333"
    }
  ];
      ...
      <div className="container mx-auto px-4">
        ...
        >
          <motion.a
            ...
            whileTap={{ scale: 0.95 }}
            href="mailto:kalyanmudike@gmail.com"
